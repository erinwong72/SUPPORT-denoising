...
% 
% session_path = '/Volumes/fanlab/Labmembers/Adrienne/Sert-ChRmine/SertChRmine23/2025-11-04_SertChRmine23_2blockBTSP/slice1/FOV6/121109_Spon30AO4';
% save_dir = '/Volumes/fanlab/Labmembers/Niveda/Testing/Noisy_Test/2';
% 
% %'/Volumes/fanlab/Labmembers/Niveda/Testing/Noisy_Test/2';
% blueStim = 'AI';
% use_support = 1;
% 
...
% addpath(fullfile(root_path,'Computer Code', 'Fan Lab', '3extract-spike'))
% addpath(fullfile(root_path, 'Computer Code', 'Image Processing'))
% 
% 
% Run_ext_spike_HipCA1VR_AIBluecrt_FanLab_functionV6_diffpaths(blueStim, session_path, save_dir, use_support)
% 
% 
% cd(save_dir)
...
%%
function [] = Run_ext_spike_HipCA1VR_AIBluecrt_FanLab_functionV6_diffpaths(blueStim, session_path, denoised_path, save_dir, use_support)
...
if ~use_support
%     save_dir = '/Volumes/fanlab/Labmembers/Niveda/Testing/Noisy_Test/2';
%     %fullfile(session_path, 'support');
% else
    save_dir = session_path;
end

load(fullfile(denoised_path,'Masks_BestIcaTrace.mat')); % cd path out of the function
...
for i = 1:nCells
    ...
    elseif ~isempty(strfind(blueStim, 'AI'))
        ...
        cd(session_path)
        Bh = load('AI Data');
       % Bh = load(fullfile(session_path, 'AI Data'));% 1, pitch; 2, lick; 3, ValveTrig; 4, synC
