...
function ICA_Choose_diffpaths(session_path, denoised_path, save_dir, use_support)
...
load(fullfile(denoised_path, 'ICA_PreResults.mat')); % loads icsTime_all, icsTimeOrig_all, icsSpace_all, nCell, t, CellImgs, MaskMov
h = openfig(fullfile(denoised_path, 'MaskTraces_RMmov.fig'), 'new', 'visible'); % Raw Traces
